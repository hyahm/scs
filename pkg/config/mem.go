...
func NewMem() *Mem {
	...
	return &Mem{
		Percent: healthDetector.Config.Probe.Mem,
		AI: &AlertInfo{
			AM:                 &message.Message{},
...
func (m *Mem) Update() {
	m.Percent = healthDetector.Config.Probe.Mem
	m.Interval = healthDetector.Config.Probe.Interval
	m.AI.ContinuityInterval = healthDetector.Config.Probe.ContinuityInterval
}
func (m *Mem) Check() {
