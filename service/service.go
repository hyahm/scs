...
type Service interface {
	// Script 操作
	AddScript(script *config.Script) error
	GetScript(name string) (*config.Script, bool)
	DeleteScript(name string)
	UpdateScript(script *config.Script) error
	GetAllScripts() map[string]*config.Script
...
// func (s *service) AddScript(script config.Script) error {
// 	s.store.SetScript(script)
// 	return nil
// }

// func (s *service) GetScript(name string) (config.Script, bool) {
...
// func (s *service) UpdateScript(script config.Script) error {
// 	s.store.SetScript(script)
// 	return nil
// }

// func (s *service) GetAllScripts() map[string]config.Script {
...
// func (s *service) stopScript(script config.Script) {
// 	if script.Disable {
// 		return
// 	}
...
// 	svc, ok := s.store.GetServerByName(name)
// 	if !ok {
// 		return server.Server{}, ErrServerNotFound
// 	}
// 	return svc, nil
// }
